<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Timkiem.aspx.cs" Inherits="Banmypham.Timkiem" %>
...
<asp:DataList ID="dlTimkiem" runat="server" BackColor="#CCFFFF" 
    RepeatColumns = "3" Width="100%" Height="750px">
    <ItemTemplate>
