...
namespace Banmypham
{
    public partial class phanma : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataTable dt = connect.getDataTable("SELECT a.MaMP, a.TenMP, a.Dongiaban, a.Anh FROM DMMypham AS a, " +
                                "LoaiMP AS c WHERE c.Maloai=a.Maloai AND c.Tenloai=N'" + "Phấn má'");
                pager.PageSize = 6;
