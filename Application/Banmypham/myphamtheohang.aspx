<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="myphamtheohang.aspx.cs" Inherits="Banmypham.Myphamtheohang" %>
...
<asp:Label ID="lblmyphamtheohang" runat="server" Font-Bold="true" Font-Size="18px">Mỹ phẩm theo hãng</asp:Label>
<asp:DataList ID="dlmyphamtheohang" runat="server" BackColor="#CCFFFF" 
    RepeatColumns = "2" Width="100%" Height="307px">
    <ItemTemplate>
