<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sanphamuachuongnhat.ascx.cs" Inherits="Banmypham.Control.Sanphamuachuongnhat" %>
...
<asp:DataList ID="dlSanpham" runat="server" BackColor="#CCFFFF" 
    RepeatColumns = "1" Width="193px" Height="307px">
    <ItemTemplate>
